...
-- 5 expected
INSERT INTO inc_backup_schema.TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES (NULL, 'a', 'a', '1', '1', '(');
-- expected ERROR 23502: Column 'PK_COL' cannot accept a NULL value.
INSERT INTO inc_backup_schema.TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '1', '4', '(');
...
INSERT INTO inc_backup_schema.TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '4', '1', '(');
...
INSERT INTO inc_backup_schema.TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'w', 'a', '1', '1', '(');
...
INSERT INTO inc_backup_schema.TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'w', '1', '1', '(');
...
-- 5 expected
INSERT INTO TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES (NULL, 'a', 'a', '1', '1', '(');
-- expected ERROR 23502: Column 'PK_COL' cannot accept a NULL value.
INSERT INTO TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '1', '4', '(');
-- expected ERROR 23505: The statement was aborted because it would have caused a duplicate key value in a unique or primary key constraint or unique index identified by 'UN_NULLS' defined on 'TABLE_4'.
INSERT INTO TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '4', '1', '(');
-- expected ERROR 23505: The statement was aborted because it would have caused a duplicate key value in a unique or primary key constraint or unique index identified by 'SQL161213132957731' defined on 'TABLE_4'.
INSERT INTO TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'w', 'a', '1', '1', '(');
-- expected ERROR 23503: Operation on table 'TABLE_4' caused a violation of foreign key constraint 'FK_EMPTY' for key (NFK_COL).  The statement has been rolled back.
INSERT INTO TABLE_4(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'w', '1', '1', '(');
-- expected ERROR 23503: Operation on table 'TABLE_4' caused a violation of foreign key constraint 'SQL161213132940800' for key (UFK_COL).  The statement has been rolled back.
