-- SYNOMINS
CREATE SYNONYM SY_CUSTOM_3 FOR INC_BACKUP_SCHEMA.SYN_TABLE;
CREATE SYNONYM SY_DEFAULT_3 FOR SYN_TABLE;
DROP SYNONYM SY_CUSTOM_2;
DROP SYNONYM SY_DEFAULT_2;

-- SEQUENCES
CREATE SEQUENCE SE_3 START WITH 300;
...
DROP ROLE role_1;
CALL SYSCS_UTIL.SYSCS_CREATE_USER('user_2', 'user_2');
CREATE ROLE role_2;
GRANT SELECT ON TABLE INC_BACKUP_SCHEMA.TUSERS_2 TO user_2;
GRANT SELECT ON TABLE TROLES_2 TO role_2;
GRANT role_2 to user_2;

GRANT SELECT ON TABLE INC_BACKUP_SCHEMA.TUSERS_2 TO user_0;
GRANT SELECT ON TABLE TROLES_2 TO role_0;
GRANT role_2 to user_0;

REVOKE SELECT ON TABLE INC_BACKUP_SCHEMA.TUSERS_1 FROM user_4;
REVOKE SELECT ON TABLE TROLES_1 FROM role_4;
