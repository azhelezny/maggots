...
SELECT count(*) from sys.SYSSEQUENCES where sequencename in ('SE_1', 'SE_4');
-- ecpected 2
SELECT count(*) from sys.SYSSEQUENCES where sequencename in ('SE_0', 'SE_2', 'SE_3', 'SE_5');
-- ecpected 0
...
SELECT count(USERNAME) from sys.SYSUSERS where USERNAME in ('USER_0', 'USER_3', 'USER_4');
-- expected 3
SELECT count(USERNAME) from sys.SYSUSERS where USERNAME in ('USER_1', 'USER_2');
-- expected 0

SELECT count(*) from sys.SYSROLES where ROLEID in ('ROLE_0', 'ROLE_3' , 'ROLE_4') and GRANTEE != 'SPLICE';
-- expected 4
SELECT count(*) from sys.SYSROLES where ROLEID in ('ROLE_1', 'ROLE_2');
-- expected 0
...
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'INC_BACKUP_SCHEMA'.'TUSERS_0'.
SELECT * FROM INC_BACKUP_SCHEMA.TUSERS_1;
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'INC_BACKUP_SCHEMA'.'TUSERS_0'.
SELECT * FROM INC_BACKUP_SCHEMA.TUSERS_2;
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'INC_BACKUP_SCHEMA'.'TUSERS_0'.
SELECT * FROM INC_BACKUP_SCHEMA.TUSERS_4;
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'INC_BACKUP_SCHEMA'.'TUSERS_4'.
...
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'SPLICE'.'TROLES_0'.
SELECT * FROM SPLICE.TROLES_1;
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'SPLICE'.'TROLES_1'.
SELECT * FROM SPLICE.TROLES_2;
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'SPLICE'.'TROLES_2'.
SELECT * FROM SPLICE.TROLES_4;
--expected ERROR 42502: User 'USER_3' does not have SELECT permission on column 'I' of table 'SPLICE'.'TROLES_4'.
...
SET ROLE role_3;
--expected ERROR 0P000: Invalid role specification, role not granted to current user or PUBLIC: 'ROLE_3'.
SET ROLE role_1;
