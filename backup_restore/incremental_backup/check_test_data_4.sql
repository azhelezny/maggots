...
-- 2 expected
SELECT count(*) as TABLES from sys.SYSTABLES where tablename IN('TABLE_4') and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME IN ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- 0 expected
...
-- 2 expected
SELECT count(*) as VIEWS from sys.SYSTABLES where tablename IN('VIEW_4') and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME IN ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- 0 expected
...
SELECT count(*) as INDEXES from sys.SYSCONGLOMERATES where isindex=true and CONGLOMERATENAME in ('I_CUSTOM_3', 'I_DEFAULT_3') in (SELECT tableid from sys.SYSTABLES where tablename = 'TABLE_0') and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME in ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- 2 expected
SELECT count(*) as INDEXES from sys.SYSCONGLOMERATES where isindex=true and CONGLOMERATENAME in ('I_CUSTOM_0', 'I_CUSTOM_1', 'I_CUSTOM_2', 'I_CUSTOM_4', 'I_DEFAULT_0', 'I_DEFAULT_1', 'I_DEFAULT_2', 'I_DEFAULT_4') in (SELECT tableid from sys.SYSTABLES where tablename = 'TABLE_0') and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME in ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- 0 expected
...
-- 5 expected
INSERT INTO inc_backup_schema.TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES (NULL, 'a', 'a', '1', '1', '(');
-- expected ERROR 23502: Column 'PK_COL' cannot accept a NULL value.
INSERT INTO inc_backup_schema.TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '1', '4', '(');
...
INSERT INTO inc_backup_schema.TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '4', '1', '(');
...
INSERT INTO inc_backup_schema.TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'w', 'a', '1', '1', '(');
...
INSERT INTO inc_backup_schema.TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'w', '1', '1', '(');
...
-- 5 expected
INSERT INTO TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES (NULL, 'a', 'a', '1', '1', '(');
-- expected ERROR 23502: Column 'PK_COL' cannot accept a NULL value.
INSERT INTO TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '1', '4', '(');
-- expected ERROR 23505: The statement was aborted because it would have caused a duplicate key value in a unique or primary key constraint or unique index identified by 'UN_NULLS' defined on 'TABLE_2'.
INSERT INTO TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '4', '1', '(');
-- expected ERROR 23505: The statement was aborted because it would have caused a duplicate key value in a unique or primary key constraint or unique index identified by 'SQL161213132957731' defined on 'TABLE_2'.
INSERT INTO TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'w', 'a', '1', '1', '(');
-- expected ERROR 23503: Operation on table 'TABLE_2' caused a violation of foreign key constraint 'FK_EMPTY' for key (NFK_COL).  The statement has been rolled back.
INSERT INTO TABLE_2(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'w', '1', '1', '(');
-- expected ERROR 23503: Operation on table 'TABLE_2' caused a violation of foreign key constraint 'SQL161213132940800' for key (UFK_COL).  The statement has been rolled back.
...
-- 5 expected
INSERT INTO inc_backup_schema.TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES (NULL, 'a', 'a', '1', '1', '(');
-- expected ERROR 23502: Column 'PK_COL' cannot accept a NULL value.
INSERT INTO inc_backup_schema.TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '1', '4', '(');
...
INSERT INTO inc_backup_schema.TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '4', '1', '(');
...
INSERT INTO inc_backup_schema.TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'w', 'a', '1', '1', '(');
...
INSERT INTO inc_backup_schema.TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'w', '1', '1', '(');
...
-- 5 expected
INSERT INTO TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES (NULL, 'a', 'a', '1', '1', '(');
-- expected ERROR 23502: Column 'PK_COL' cannot accept a NULL value.
INSERT INTO TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '1', '4', '(');
-- expected ERROR 23505: The statement was aborted because it would have caused a duplicate key value in a unique or primary key constraint or unique index identified by 'UN_NULLS' defined on 'TABLE_3'.
INSERT INTO TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'a', '4', '1', '(');
-- expected ERROR 23505: The statement was aborted because it would have caused a duplicate key value in a unique or primary key constraint or unique index identified by 'SQL161213132957731' defined on 'TABLE_3'.
INSERT INTO TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'w', 'a', '1', '1', '(');
-- expected ERROR 23503: Operation on table 'TABLE_3' caused a violation of foreign key constraint 'FK_EMPTY' for key (NFK_COL).  The statement has been rolled back.
INSERT INTO TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'a', 'w', '1', '1', '(');
-- expected ERROR 23503: Operation on table 'TABLE_3' caused a violation of foreign key constraint 'SQL161213132940800' for key (UFK_COL).  The statement has been rolled back.


-- TRIGGERS

SELECT triggername from sys.SYSTRIGGERS where tableid in (SELECT tableid from sys.SYSTABLES where tablename = 'TABLE_3') and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME in ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- expected 
		--T_CUSTOM_3
		--T_DEFAULT_3

INSERT INTO INC_BACKUP_SCHEMA.TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'c', 'c', '5', '5', ')');
INSERT INTO TABLE_3(pk_col, nfk_col, ufk_col, nun_col, uun_col, inx_col) VALUES ('T', 'c', 'c', '5', '5', ')');
...
DELETE FROM INC_BACKUP_SCHEMA.TABLE_3 WHERE pk_col ='T';
DELETE FROM TABLE_3 WHERE pk_col ='T';

-- PROCEDURES

SELECT count(*) from sys.SYSALIASES where alias = 'GET_ABS_3' and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME in ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- expected 2
SELECT count(*) from sys.SYSALIASES where alias in ('GET_ABS_0', 'GET_ABS_1', 'GET_ABS_2', 'GET_ABS_4') and schemaid in (SELECT SCHEMAID from sys.SYSSCHEMAS WHERE SCHEMANAME in ('INC_BACKUP_SCHEMA', 'SPLICE'));
-- expected 0
