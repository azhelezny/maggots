...
call SYSCS_UTIL.SYSCS_BACKUP_DATABASE('hdfs:///automation/incremental', 'full');
call SYSCS_UTIL.SYSCS_BACKUP_DATABASE('/automation/incremental', 'full');
call SYSCS_UTIL.SYSCS_BACKUP_DATABASE('hdfs:///automation/incremental', 'incremental');
call SYSCS_UTIL.SYSCS_BACKUP_DATABASE('/automation/incremental', 'incremental');

call SYSCS_UTIL.SYSCS_RESTORE_DATABASE('hdfs:///automation/incremental', );

call SYSCS_UTIL.SYSCS_DELETE_BACKUP( );
...
hfs -rm -R -f /automation/incremental
hfs -mkdir /automation
hfs -mkdir /automation/incremental
