...
create table vacuum.vac_t;(id INT generated by default as identity, c_char char(30), c_vchar varchar(30), c_time TIME, c_date DATE, c_tstamp TIMESTAMP, c_num NUMERIC,  )

create table t_1(id INT generated by default as identity, c_char char(30), c_vchar varchar(30), c_time TIME, c_date DATE, c_tstamp TIMESTAMP, c_num NUMERIC,  )

UPDATE t_1 SET c_tstamp = '1946-06-31 10:53:53.253' where id = 6;
UPDATE t_1 SET c_date = '1946-06-31' where id = 6;
...
2. Open HBASE UI on master node: http://<Naster Node URL>:16010/master-status
